...
import { fetchDocuments, fetchCases, createDocument, deleteDocument } from '../services/api';
import '../components/DocumentTable.css';
...
const Documents = () => {
    ...
    const [newDoc, setNewDoc] = useState({ title: '', type: 'Contract', status: 'Pending', assignedTo: '', caseId: '' });

    const loadDocuments = async () => {
        setLoading(true);
        try {
            const [docRes, caseRes] = await Promise.all([fetchDocuments(), fetchCases()]);
    ...
    const handleAdd = async (e) => {
        ...
        try {
            ...
            setIsAdding(false);
            setNewDoc({ title: '', type: 'Contract', status: 'Pending', assignedTo: '', caseId: '' });
            loadDocuments();
            window.dispatchEvent(new Event('dataUpdated'));
        } catch (err) {
                    ...
                    <div className="modal-content glass-panel">
                        ...
                        <form onSubmit={handleAdd}>
                            ...
                            <div className="form-group">
                                ...
                                <select value={newDoc.caseId} onChange={e => setNewDoc({ ...newDoc, caseId: e.target.value })}>
